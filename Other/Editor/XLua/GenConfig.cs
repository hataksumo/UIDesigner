...
public static class GenConfig
{
    ...
    public static List<Type> LuaCallCSharp = new List<Type>() {
        ...
        typeof(System.GC),
        typeof(HjTcpNetwork),
        typeof(SceneDataUtilities),
        typeof(SceneDataAsset),
        typeof(ParticleScaleUtility),
        typeof(LJ_TimelineExtension.PlayableDirectorBindingHelper),
        typeof(CommonUtils),
        typeof(AudioManager),
        typeof(GameConfigJson),
        typeof(SharpZip),
        typeof(UIDrag),
        typeof(UIDrop),
        typeof(UICustom.ScrollRectDragCustom),
        typeof(GameChannel.LJAccount),
        typeof(GameChannel.ChannelManager),
        typeof(GameChannel.BaseChannel),
        typeof(RolePartConfig),
        typeof(JGPush)
    };
    ...
    public static List<Type> CSharpCallLua = new List<Type>() {
        ...
        typeof(Action<int>),
        typeof(Action<WWW>),
        typeof(Action<GameChannel.LJAccount>),
        ...
        typeof(Action<MapSys.LineInfo, bool>),
