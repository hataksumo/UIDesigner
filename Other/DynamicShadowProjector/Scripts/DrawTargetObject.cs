...
namespace DynamicShadowProjector
{
    ...
    public class DrawTargetObject : MonoBehaviour
    {
        ...
        [SerializeField]
        private Transform[] m_OtherNodes;
        [SerializeField]
        ...
        public Transform[] OtherNodes
        {
            get { return m_OtherNodes; }
            set
            {
                m_OtherNodes = value;
                SetCommandBufferDirty();
        ...
        public void UpdateCommandBuffer()
        {
            ...
            if (m_OtherNodes != null && m_OtherNodes.Length > 0)
            {
                for (int i = 0 ; i < m_OtherNodes.Length ; i++)
                {
                    var node = m_OtherNodes[i];
                    if (node == null) continue;
                    Renderer[] renderers = node.gameObject.GetComponentsInChildren<Renderer>();
