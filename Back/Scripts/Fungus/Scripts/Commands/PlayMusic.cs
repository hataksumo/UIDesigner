...
namespace Fungus
{
    ...
    public class PlayMusic : Command
    {
        ...
        [SerializeField] public string musicClipName;
        ...
        {
            PreviousMusic = LJAudio.AudioManager.instance.CurPlayingMusic;
            ...
            {
                LJAudio.AudioManager.PlayMusicInterface(musicClipName, atTime);
            } 
            Continue();
        }
