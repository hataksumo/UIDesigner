...
namespace Fungus
{
    ...
    public class Character : MonoBehaviour, ILocalizable
    {
        ...
        [SerializeField] public DialogPortrait displayPortrait;
        [SerializeField] public int[] defaultProtraitLayerSetting;
        ...
        /// </summary>
        public virtual List<Sprite> Portraits { get { return portraits; } set { portraits = value; } }
