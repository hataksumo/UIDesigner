...
namespace AssetBundles
{
    public class AssetBundleConfig
    {
        ...
        public const string AssetBundlesAudioFolderName = "Audio";
        public const string AssetBundlesAudioFolderName_GEN = "Audio/GeneratedSoundBanks";
        public const string WWISESoundbanksInfo = "SoundbanksInfo.txt";
        public const string WWISESoundbanksInfo_XML = "SoundbanksInfo.xml";
        public const string WWISESoundbanksInfoPath = "Wwise/Resources/SoundbanksInfo.txt";
        public const string WWISEAssetBundlAudioPath = "AssetsPackage/Art/Audio/GeneratedSoundBanks";
        public const string StoryVideoSrcPath = "AssetsPackage/Art/StoryVideo";
        public const string StoryVideoPath = "StoryVideo";
#if UNITY_EDITOR
        ...
        public static string AssetBundlesAudioBuildOutputPath
        {
            get
            {
                string outputPath = Path.Combine(System.Environment.CurrentDirectory, AssetBundlesAudioFolderName);
                GameUtility.CheckDirAndCreateWhenNeeded(outputPath);
                return outputPath;
            }
        }
