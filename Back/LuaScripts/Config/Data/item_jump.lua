...
return{
	...
	[53] = {ID = 53,AddJump = {Title = _T("兑换"),Des = _T("使用守护灵残魂兑换"),To = 20400},IfJump = 1},--武灵技背包全部页
	...
	[61] = {ID = 61,AddJump = {Title = _T("冒险"),Des = _T("每个关卡首通均可获得历练值"),To = 10101},IfJump = 1},--冒险经验
	[62] = {ID = 62,AddJump = {Title = _T("探险"),Des = _T("使用加速令可快速获取历练值"),To = 10501,Param = {302}},IfJump = 1},--探险经验
	[63] = {ID = 63,AddJump = {Title = _T("冒险宝箱"),Des = _T("冒险奖励宝箱开出"),To = 10101},IfJump = 0},--冒险宝箱
	[64] = {ID = 64,AddJump = {Title = _T("限时活动"),Des = _T("登录礼包、嘉年华等限时活动产出")},IfJump = 0}--限时活动
}