...
colums:
{GroupId,组ID} ,{HelpCol,辅助列} ,{Order,顺位} ,{Name,名字} ,{Quality,品质} ,{Cost[1].Id,消耗道具ID1} ,{Cost[1].Val,消耗数量1} ,{Cost[2].Id,消耗道具ID2} ,{Cost[2].Val,消耗数量2} ,{Cost[3].Id,消耗道具ID3} ,{Cost[3].Val,消耗数量3} ,{Prop[1].Id,属性ID1} ,{Prop[1].Val,属性值1} ,{Prop[2].Id,属性ID2} ,{Prop[2].Val,属性值2} ,{Prop[3].Id,属性ID3} ,{Prop[3].Val,属性值3} ,{AttrDesc,属性描述}
primary key:
#0 [收集子项]: ID
]]
return{
