...
colums:
{GroupId,组ID} ,{Name,名字} ,{RewardQuality,奖励品质} ,{Prop[1].Id,属性ID1} ,{Prop[1].Val,属性值1} ,{Prop[2].Id,属性ID2} ,{Prop[2].Val,属性值2} ,{Prop[3].Id,属性ID3} ,{Prop[3].Val,属性值3} ,{Award[1].Id,奖励ID1} ,{Award[1].Val,奖励值1} ,{Award[2].Id,奖励ID2} ,{Award[2].Val,奖励值2} ,{Award[3].Id,奖励ID3} ,{Award[3].Val,奖励值3}
primary key:
#0 [收集组]: GroupId
]]
return{
