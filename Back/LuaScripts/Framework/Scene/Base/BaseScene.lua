...
local function OnComplete(self)
	DataManager:GetInstance():Broadcast(DataMessageNames.ON_SCENE_CHANGE,self.scene_config.Name)
	if self.scene_config.Name ~= "LoginScene"  and self.scene_config.Name ~= "BattleScene" and self.scene_config.Name ~= "PVPBattleScene" then
		--聊天
...
local function OnLeave(self)
	--存储最后一个ui背景
	UIManager:GetInstance():LeaveSceneSave(self.scene_config.Name)
end
