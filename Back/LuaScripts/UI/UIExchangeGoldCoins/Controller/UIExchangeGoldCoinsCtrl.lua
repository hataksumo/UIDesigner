...
local UIExchangeGoldCoinsCtrl = BaseClass("UIExchangeGoldCoinsCtrl", UIBaseCtrl)


local function CloseSelf(self)
	UIManager:GetInstance():CloseWindow(UIWindowNames.UIExchangeGoldCoins)
end
--兑换金币
...
UIExchangeGoldCoinsCtrl.CloseSelf = CloseSelf
UIExchangeGoldCoinsCtrl.BeginExchangeCoin=BeginExchangeCoin
return UIExchangeGoldCoinsCtrl