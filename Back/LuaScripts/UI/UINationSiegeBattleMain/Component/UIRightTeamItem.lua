local UIRightTeamItem = BaseClass("UIRightTeamItem", UIWrapComponent)
...
local function OnRefresh(self, real_index, check)
    local itemData = self.view.model.defendTeamTab[real_index]
    ...
    elseif itemData.State == NationDefine.SIEGE_KILL_TEAM_STATE.PREPARE then
        ...
        self.state_text:SetText(DataUtil.GetClientText(200161))
    end
...
UIRightTeamItem.OnCreate = OnCreate
UIRightTeamItem.OnRefresh = OnRefresh
return UIRightTeamItem