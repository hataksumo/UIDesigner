...
--- Created by LJ095.
--- DateTime: 2019/3/1 15:36
---

local UIHeadFrameWrapItem = BaseClass("UIHeadFrameWrapItem", UIWrapComponent)
...
UIHeadFrameWrapItem.OnCreate = OnCreate
UIHeadFrameWrapItem.OnRefresh = OnRefresh
return UIHeadFrameWrapItem