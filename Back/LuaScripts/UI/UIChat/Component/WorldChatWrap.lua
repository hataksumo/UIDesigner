...
local WorldChatWrap = BaseClass("WorldChatWrap", UIWrapComponent)
...
local function OnRefresh(self, real_index)
    local data = self.view.world_list[real_index]
    local comp = nil
    self.id = data.id
    ...
    --Logger.Log("textImage : " .. comp.rankBg.rectTransform.sizeDelta.x)
    ----- 0.5是组件的scale 48 是偏移值
    --comp.rankBg.rectTransform.sizeDelta = Vector2.New(comp.rankImageText.rectTransform.sizeDelta.x * 0.5 + 48, comp.rankBg.rectTransform.sizeDelta.y)
    comp.bg.sizeDelta = data.size
end

WorldChatWrap.OnCreate = OnCreate
WorldChatWrap.OnRefresh = OnRefresh
return WorldChatWrap