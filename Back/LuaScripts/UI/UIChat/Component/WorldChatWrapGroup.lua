...
--- Created by aaa.
--- DateTime: 2019/2/25 10:04
---
local WorldChatWrapGroup = BaseClass("WorldChatWrapGroup", UIBaseContainer)
...
local function SetMoveLast(self,...)
    self.__movelast = BindCallback(...)
end
...
WorldChatWrapGroup.CheckIsLast = CheckIsLast
WorldChatWrapGroup.UpdateLength = UpdateLength
WorldChatWrapGroup.OnInit = OnInit
WorldChatWrapGroup.OnCreate = OnCreate
WorldChatWrapGroup.SetMoveLast = SetMoveLast
WorldChatWrapGroup.SetOnClick = SetOnClick
WorldChatWrapGroup.SetLength = SetLength
WorldChatWrapGroup.AddComponent = AddComponent
WorldChatWrapGroup.ResetToBeginning = ResetToBeginning
WorldChatWrapGroup.ResetToTop = ResetToTop
WorldChatWrapGroup.WrapContent = WrapContent
WorldChatWrapGroup.OnDestroy = OnDestroy
WorldChatWrapGroup.GetComponentByIndex = GetComponentByIndex

return WorldChatWrapGroup