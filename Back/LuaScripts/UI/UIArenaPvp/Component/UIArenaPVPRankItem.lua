...
--- Created by ljl.
--- DateTime: 2019/7/23 15:28
---
local UIArenaPVPRankItem=BaseClass("UIArenaPVPRankItem",UIWrapComponent)
...
local function OnRefresh(self,real_index)
    ...
    self.score:SetText(math.floor(self.single_data.score))
    if self.single_data.rank == 1 then
    ...
    elseif self.single_data.rank == 2 then
        self.rank_img.gameObject:SetActive(true)
        self.rank_img:SetSpriteName("ui_t_Arena_022")
        self.rank_text.gameObject:SetActive(false)
    elseif self.single_data.rank == 3 then
        self.rank_img.gameObject:SetActive(true)
        ...
        self.rank_text:SetText(math.floor(self.single_data.rank))
    end
end

UIArenaPVPRankItem.OnCreate = OnCreate
UIArenaPVPRankItem.OnSkillItemClick = OnSkillItemClick
UIArenaPVPRankItem.OnRefresh=OnRefresh

return UIArenaPVPRankItem