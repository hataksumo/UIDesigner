...
function utf8.Bytes4Character(theByte)
...
--按字节算长度，aChineseCharBytes中文占的字节数，默认为2
function utf8.charactersLength(utf8Str, aChineseCharBytes)
	aChineseCharBytes = aChineseCharBytes or 2
	local i = 1
	local characterSum = 0
	while (i <= #utf8Str) do      -- 编码的关系
		local bytes4Character = utf8.Bytes4Character(string.byte(utf8Str, i))
