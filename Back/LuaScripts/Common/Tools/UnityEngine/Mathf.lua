...
function Mathf.FormulaFour(str,agr)
	local val = string.split(str,"#",1,true)
	for i = 1, 4 do
		if val[i] == nil or tonumber(val[i]) == nil then
			Logger.LogError("参数错误  "..str)
			return 0
		end
	end
	return val[1]*agr*agr*agr+val[2]*agr*agr+val[3]*agr+val[4]
end
